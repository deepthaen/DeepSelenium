...
public class ProductNamesInLisiting {
...
System.setProperty("webdriver.chrome.driver", "C:\\Users\\DEEPTHA.NAIK\\Downloads\\chromedriver_win32\\chromedriver.exe");
		...
		List<WebElement> rows = driver.findElements(By.className("nw-productview-producttitle"));
	...
	//div[@class='nw-productview-producttitle']
}
